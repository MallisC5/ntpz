...
– .HTTP-NUKE : USE HTTP1 + RAW + SOCKET + BYPASS GTPS ANTI DDOS PORT 80 - 443
 """
...
def main():
	...
	while True:
		...
		sin = input("\033[0;30;45mᴄᴇᴏᴡ @ ʙʀɪʟᴀɴᴅ\x1b[1;37m\033[0m:~# \x1b[1;37m\033[0m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
