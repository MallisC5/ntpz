...
– .AMP : Multiple Amplification Methods
– .OVH-TCP : TCP OVH Interno Bypass
– .OVH-UDP : UDP OVH Game Bypass
– .FIVEM : Game Flood Optimized For FM
– .TCP : TCP Socket Flood and SYN-ACK
– .NFO : SYN Flood + Raw UDP + Handshake
– .R6-DROP : Game Flood Optimized For R6
– .RN -DROP : Game Flood Optimized For FN
– .SSH-DOWN : SSH V1/1.1/2 Flood

[ LAYER - 7 ]

– .BYPASS : USE HTTP1 / HTTP2 BYPASS CAPTCHA , UAM , BOTFIGHT ETC.
– .TLS : USE TLSV1 + TLS V2 CAN BYPASS UAM , CF NOSEC ETC.
– .HTTPS : HTTP1 / HTTP2 USE GET + POST FLOOD RAWRRR.
– .BROWSER : USE HTTP 1 + 2 / BYPASS ALL RULES EXISTING WEBSITE DEFENSE.
– .HTTP-BOTNET : USE HTTP1 + RAW + SOCKET + BYPASS GTPS ANTI DDOS PORT 80 - 443
...
– .BYPASS: [ HOSTNAME ] [ PORT ] [ RATE LIMIT MAX 120 ] [ TIME ]
– .TLS: [ HOSTNAME ] [ PORT ] [ RATE LIMIT MAX 64 ] [ TIME ]
– .HTTPS: [ HOSTNAME ] [ PORT ] [ RATE LIMIT MAX 64 ] [ TIME ]
– .BROWSER: [ HOSTNAME ] [ PORT ] [ RATE LIMIT MAX 120 ] [ TIME ]
– .HTTP-BOTNET: [ HOSTNAME ] [ PORT ] [ RATE LIMIT MAX 80 ] [ TIME ]
 """
...
Version, V2
2022 - 2023
\x1b[1;37mᴘʟᴇᴀsᴇ ᴛʏᴘᴇ " 𝓶𝓮𝓽𝓱𝓸𝓭𝓼 " ᴛᴏ sᴇᴇ ᴀʟʟ ᴛʜᴇ ᴍᴇᴛʜᴏᴅs ʙʀɪʟᴀɴᴅ.
"""
...
def main():
	...
	while True:
		...
		sin = input("\033[0;30;44mᴄᴇᴏᴡ @ ʙʀɪʟᴀɴᴅ\x1b[1;37m\033[0m:~# \x1b[1;37m\033[0m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
